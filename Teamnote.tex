...
\section{Data Structures}
  ...
  Greater $(s, e, k)$ : Number of elements Larger than $k$ in $[s, e)$
    \verbatiminput{./code/Data_Structures/merge_sort_tree.cpp}
...
\section{Mathematics}
  \subsection{Useful Mathematical Formula}
    \begin{itemize}
      ...
      \]
      \item Binomial Coefficient $\binom{n}{k} = \binom{n-1}{k} + \binom{n-1}{k-1}$
...
\section{Geometry}
  ...
  \subsection{Graham Scan + Rotating Calipers}
    \verbatiminput{./code/Geometry/Convex_Hull.cpp}
...
\section{Graphs}
  ...
  \subsection{SCC with 2-SAT Solving}
    \verbatiminput{./code/Graph/Twosat_Cosaraju.cpp}
